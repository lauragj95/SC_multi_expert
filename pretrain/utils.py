...
from pretrain.eval_knn import extract_multiple_features, knn_classifier
...
def train_one_epoch(
    ...
    writer.add_scalar('train_loss', np.mean(final_loss), epoch+1)
    writer.flush()
